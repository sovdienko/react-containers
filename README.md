...
1. Погружение в React: роутер
http://prgssr.ru/development/pogruzhenie-v-react-router.html

2. Погружение в React: контейнеры
http://prgssr.ru/development/pogruzhenie-v-react-kontejnery.html

npm install -g json-server
json-server --watch data/restore.json --port 3004

3.Погружение в React: Redux
